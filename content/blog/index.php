<?php 
$meta_title ="Indie Hacker Resources: Beautiful Websites";
$meta_description ="A curated selection of web tools, comparisons, and actionable insights for indie hackers navigating the digital landscape.";
?>


<section class="bg-white border-b-2 border-dotted py-8">
    <div class="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
        <h2 class="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Indie Hacker Resources</h2>
        <p class="font-light text-gray-500 sm:text-xl dark:text-gray-400">A curated selection of web tools, comparisons, and actionable insights for indie hackers navigating the digital landscape.</p>
    </div> 
