<?php 
$meta_title ="Webpage Sherlock: Your Ultimate Page Insights Chrome Extension";
$meta_description ="Your handy tool for addressing SEO and user experience challenges. Simply click on the extension and receive an instant snapshot of meta information, word count, images, broken links, rich previews, favicons, and more.";
$og_image_url ="assets/imgs/website-sherlock/og-image.png";
?>
...
<div class="bg-gray-50">
    ...
    <main class="px-2 max-w-screen-xl mx-auto">
        ...
        <section>
            <div class="py-8 px-4 lg:py-16 lg:px-6">
                <div class="text-gray-500 sm:text-lg">
                    <h2 class="mb-4 text-4xl tracking-tight font-bold text-gray-900">Customizing Webpage Sherlock Extension Shortcut</h2>
                    <p class="mb-4 font-light">Open your Chrome browser and type <span class="text-blue-600">chrome://extensions/shortcuts</span> into the address bar, then press Enter.</p>
                    <p class="mb-4 font-light">You will be directed to the shortcut management page, where you'll find cards representing each of the extensions you have installed.</p>
                    <p class="mb-4 font-light">Locate the card for the "Webpage Sherlock" extension and click on it. Look for the pencil icon on the "Webpage Sherlock" card and click on it to begin editing the extension's shortcut.</p>
                    <p class="mb-4 font-light">Now, input the new shortcut keys that you want to assign to the extension. As soon as you enter the new shortcut, it will be instantly activated and ready for use.</p>
                </div>
            </div>
        </section>
